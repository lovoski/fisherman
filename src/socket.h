...
#define __ERROR__(msg) printf(msg);
...
public:
  ...
  void sendTo(const void *buffer, int bufferLen, sockaddr_in &client_addr);
  /**
  ...
  int recvFrom(void *buffer, int bufferlen, sockaddr_in &client_addr);
